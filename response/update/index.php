...
$id = $_GET['id'];
$query = query("SELECT * FROM report WHERE id_report = $id")[0];



if (isset($_POST["submit"])) {

    if (editRespon($_POST) > 0) {
        echo
        "<script>
                        ...
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="date" name="date" value="<?= $query['date_of_submission']; ?>" required disabled>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="date_1" class="col-sm-2 col-form-label" style="width: 15rem;">Date of Hazard Identification</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="date_1" name="date_!" value="<?= $query['date_of_hazard']; ?>" required disabled>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="location" class="col-sm-2 col-form-label" style="width: 15rem;">Location</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="location" name="location" value="<?= $query['location']; ?>" required disabled>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="type" class="col-sm-2 col-form-label" style="width: 15rem;">Type of Operation</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="type" name="type" value="<?= $query['type_operation']; ?>" required disabled>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="hazard" class="col-sm-2 col-form-label" style="width: 15rem;">Hazard Description</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="hazard" name="hazard" value="<?= $query['description']; ?>" required disabled>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="respon" class="col-sm-2 col-form-label" style="width: 15rem;">Respon Hazard</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="respon" name="respon" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="gambar" class="col-sm-2 col-form-label" style="width: 15rem;">Image</label>
                                    <div class="col-sm-6">
