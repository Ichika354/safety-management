                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <label for="mitigation" class="col-sm-2 col-form-label" style="width: 15rem;">Post Mitigation</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="mitigation" name="mitigation" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="status" class="col-sm-2 col-form-label" style="width: 15rem;">Status</label>
                                    <div class="col-sm-6">
